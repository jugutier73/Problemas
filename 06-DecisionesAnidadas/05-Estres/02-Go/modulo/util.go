...
// IngresarLogico muestra una pregunta y devuelve el booleano ingresado por el usuario o falso si es un valor inválido.
...
// IngresarOpcion muestra una pregunta de un máximo de opciones y devuelve el entero o uno si es un valor inválido.
