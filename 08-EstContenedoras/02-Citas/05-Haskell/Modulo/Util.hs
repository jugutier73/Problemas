...
module Modulo.Util (mostrarMensaje, mostrarError, ingresarTexto, ingresarEntero, ingresarReal, ingresarLogico, ingresarOpcion, ingresarColeccion, ordenarColeccion, convertirColeccionCadena) where
